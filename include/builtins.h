static struct {
  ...
  { .module = "curl/core",  .name = "trace",                    .value = BUILTIN(builtin_curl_trace)             },
  ...
  { .module = "curl/core",  .name = "CURLOPT_COOKIE",           .value = INT(CURLOPT_COOKIE)                     },
  { .module = "curl/core",  .name = "CURLOPT_COOKIEFILE",       .value = INT(CURLOPT_COOKIEFILE)                 },
  { .module = "curl/core",  .name = "CURLOPT_COOKIEJAR",        .value = INT(CURLOPT_COOKIEJAR)                  },
  { .module = "curl/core",  .name = "CURLOPT_COOKIELIST",       .value = INT(CURLOPT_COOKIELIST)                 },
  ...
  { .module = "curl/core",  .name = "CURLOPT_VERBOSE",          .value = INT(CURLOPT_VERBOSE)                    },
  { .module = "curl/core",  .name = "CURLOPT_DEBUGFUNCTION",    .value = INT(CURLOPT_DEBUGFUNCTION)              },
  { .module = "curl/core",  .name = "CURLOPT_HTTP_VERSION",     .value = INT(CURLOPT_HTTP_VERSION)               },
  { .module = "curl/core",  .name = "CURLINFO_RESPONSE_CODE",   .value = INT(CURLINFO_RESPONSE_CODE)             },
  { .module = "curl/core",  .name = "CURL_HTTP_VERSION_1_1",    .value = INT(CURL_HTTP_VERSION_1_1)              },
  { .module = "curl/core",  .name = "CURL_HTTP_VERSION_2",      .value = INT(CURL_HTTP_VERSION_2_0)              },
  { .module = "curl/core",  .name = "CURL_HTTP_VERSION_2TLS",   .value = INT(CURL_HTTP_VERSION_2TLS)             },
  { .module = "curl/core",  .name = "CURL_HTTP_VERSION_NONE",   .value = INT(CURL_HTTP_VERSION_NONE)             },
  ...
  { .module = "ty",         .name = "module",                   .value = BUILTIN(builtin_ty_module)              },
