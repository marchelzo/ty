static struct {
  ...
  { .module = NULL,         .name = "random",                   .value = BUILTIN(builtin_random)                  },
  ...
  { .module = NULL,         .name = "show",                     .value = BUILTIN(builtin_show)                    },
  ...
  { .module = "ty",         .name = "hash",                     .value = BUILTIN(builtin_hash)                    },
  ...
  { .module = NULL,         .name = "sha512",                   .value = BUILTIN(builtin_sha512)                  },
  { .module = "_hash",      .name = "new",                      .value = BUILTIN(builtin_hash_new)                },
  { .module = "_hash",      .name = "update",                   .value = BUILTIN(builtin_hash_update)             },
  { .module = "_hash",      .name = "digest",                   .value = BUILTIN(builtin_hash_digest)             },
  { .module = "_hash",      .name = "copy",                     .value = BUILTIN(builtin_hash_copy)               },
  ...
  { .module = "bit",        .name = "shl",                      .value = BUILTIN(builtin_bit_shift_left)          },
  { .module = "bit",        .name = "shr",                      .value = BUILTIN(builtin_bit_shift_right)         },
  ...
  { .module = "os",         .name = "fchmod",                   .value = BUILTIN(builtin_os_fchmod)               },
  { .module = "os",         .name = "fchown",                   .value = BUILTIN(builtin_os_fchown)               },
  { .module = "os",         .name = "mkdir",                    .value = BUILTIN(builtin_os_mkdir)                },
  { .module = "os",         .name = "mkfifo",                   .value = BUILTIN(builtin_os_mkfifo)               },
  { .module = "os",         .name = "rmdir",                    .value = BUILTIN(builtin_os_rmdir)                },
  { .module = "os",         .name = "chdir",                    .value = BUILTIN(builtin_os_chdir)                },
  { .module = "os",         .name = "chroot",                   .value = BUILTIN(builtin_os_chroot)               },
  ...
  { .module = "os",         .name = "pread",                    .value = BUILTIN(builtin_os_pread)                },
  { .module = "os",         .name = "pwrite",                   .value = BUILTIN(builtin_os_pwrite)               },
...
#ifdef __linux__
  { .module = "os",         .name = "pipe2",                    .value = BUILTIN(builtin_os_pipe2)                },
#endif
  ...
  { .module = "os",         .name = "mprotect",                 .value = BUILTIN(builtin_os_mprotect)             },
  ...
  { .module = "os",         .name = "socketpair",               .value = BUILTIN(builtin_os_socketpair)           },
  ...
  { .module = "os",         .name = "pause",                    .value = BUILTIN(builtin_os_pause)                },
  { .module = "os",         .name = "isatty",                   .value = BUILTIN(builtin_os_isatty)               },
  { .module = "os",         .name = "ttyname",                  .value = BUILTIN(builtin_os_ttyname)              },
  ...
  { .module = "os",         .name = "eventfd",                  .value = BUILTIN(builtin_os_eventfd)              },
  ...
  { .module = "os",         .name = "inotify_init",             .value = BUILTIN(builtin_os_inotify_init)         },
  { .module = "os",         .name = "inotify_add_watch",        .value = BUILTIN(builtin_os_inotify_add_watch)    },
  { .module = "os",         .name = "inotify_rm_watch",         .value = BUILTIN(builtin_os_inotify_rm_watch)     },
  ...
  { .module = "os",         .name = "signalfd",                 .value = BUILTIN(builtin_os_signalfd)             },
  { .module = "os",         .name = "SFD_CLOEXEC",              .value = INT(SFD_CLOEXEC)                         },
  { .module = "os",         .name = "SFD_NONBLOCK",             .value = INT(SFD_NONBLOCK)                        },

  { .module = "os",         .name = "timerfd_create",           .value = BUILTIN(builtin_os_timerfd_create)       },
  { .module = "os",         .name = "timerfd_settime",          .value = BUILTIN(builtin_os_timerfd_settime)      },
  { .module = "os",         .name = "timerfd_gettime",          .value = BUILTIN(builtin_os_timerfd_gettime)      },
  ...
  { .module = "os",         .name = "lseek",                    .value = BUILTIN(builtin_os_lseek)                },
  ...
  { .module = "thread",     .name = "note",                     .value = BUILTIN(builtin_thread_note)             },
  { .module = "thread",     .name = "notify",                   .value = BUILTIN(builtin_thread_notify)           },
  { .module = "thread",     .name = "notified?",                .value = BUILTIN(builtin_thread_is_notified)      },
  { .module = "thread",     .name = "waitNote",                 .value = BUILTIN(builtin_thread_wait_note)        },
  { .module = "thread",     .name = "counter",                  .value = BUILTIN(builtin_thread_counter)          },
  { .module = "thread",     .name = "countAdd",                 .value = BUILTIN(builtin_thread_count_add)        },
  { .module = "thread",     .name = "countValue",               .value = BUILTIN(builtin_thread_count_value)      },
  { .module = "thread",     .name = "countWait",                .value = BUILTIN(builtin_thread_count_wait)       },
  { .module = "thread",     .name = "waitAny",                  .value = BUILTIN(builtin_thread_wait_any)         },
  { .module = "thread",     .name = "atomic",                   .value = BUILTIN(builtin_thread_atomic)           },
  { .module = "thread",     .name = "load",                     .value = BUILTIN(builtin_thread_atomic_load)      },
  { .module = "thread",     .name = "store",                    .value = BUILTIN(builtin_thread_atomic_store)     },
  { .module = "thread",     .name = "swap",                     .value = BUILTIN(builtin_thread_atomic_swap)      },
  { .module = "thread",     .name = "trySwap",                  .value = BUILTIN(builtin_thread_atomic_cmpxchg)   },
  { .module = "thread",     .name = "fetchAdd",                 .value = BUILTIN(builtin_thread_atomic_fetch_add) },
  { .module = "thread",     .name = "fetchSub",                 .value = BUILTIN(builtin_thread_atomic_fetch_sub) },
  ...
  { .module = "termios",    .name = "tcgetpgrp",                .value = BUILTIN(builtin_termios_tcgetpgrp)       },
  { .module = "termios",    .name = "tcsetpgrp",                .value = BUILTIN(builtin_termios_tcsetpgrp)       },
  { .module = "termios",    .name = "tcgetsid",                 .value = BUILTIN(builtin_termios_tcgetsid)        },
  { .module = "termios",    .name = "tcflush",                  .value = BUILTIN(builtin_termios_tcflush)         },
  { .module = "termios",    .name = "tcflow",                   .value = BUILTIN(builtin_termios_tcflow)          },
  { .module = "termios",    .name = "tcdrain",                  .value = BUILTIN(builtin_termios_tcdrain)         },
  { .module = "termios",    .name = "tcsendbreak",              .value = BUILTIN(builtin_termios_tcsendbreak)     },
#endif

  { .module = "ffi",        .name = "new",                      .value = BUILTIN(cffi_new)                        },
  { .module = "ffi",        .name = "box",                      .value = BUILTIN(cffi_box)                        },
  ...
  { .module = "ffi",        .name = "auto",                     .value = BUILTIN(cffi_auto)                       },
  { .module = "ffi",        .name = "newAuto",                  .value = BUILTIN(cffi_new_auto)                   },
  { .module = "ffi",        .name = "boxAuto",                  .value = BUILTIN(cffi_box_auto)                   },
  ...
  { .module = "ffi",        .name = "c_str",                    .value = BUILTIN(cffi_c_str)                      },
  { .module = "ffi",        .name = "calcsize",                 .value = BUILTIN(cffi_calcsize)                   },
  { .module = "ffi",        .name = "pack",                     .value = BUILTIN(cffi_pack)                       },
  { .module = "ffi",        .name = "unpack",                   .value = BUILTIN(cffi_unpack)                     },
  { .module = "atomic",     .name = "load",                     .value = BUILTIN(cffi_load_atomic)                },
  { .module = "atomic",     .name = "store",                    .value = BUILTIN(cffi_store_atomic)               },
  ...
  { .module = "ty",         .name = "id",                       .value = BUILTIN(builtin_ty_id)                   },
  ...
  { .module = "ty/mod",     .name = "imports",                   .value = BUILTIN(builtin_ty_mod_imports)         },
  { .module = "ty/mod",     .name = "lookup",                    .value = BUILTIN(builtin_ty_mod_lookup)          },
...
#include "errno_constants.h"
  ...
  { .module = "accelerate", .name = "vadd",          .value = BUILTIN(builtin_accel_vadd)            },
  { .module = "accelerate", .name = "vsub",          .value = BUILTIN(builtin_accel_vsub)            },
  { .module = "accelerate", .name = "vmul",          .value = BUILTIN(builtin_accel_vmul)            },
  { .module = "accelerate", .name = "vdiv",          .value = BUILTIN(builtin_accel_vdiv)            },
  { .module = "accelerate", .name = "vsadd",         .value = BUILTIN(builtin_accel_vsadd)           },
  { .module = "accelerate", .name = "vsmul",         .value = BUILTIN(builtin_accel_vsmul)           },
  { .module = "accelerate", .name = "vsdiv",         .value = BUILTIN(builtin_accel_vsdiv)           },
  { .module = "accelerate", .name = "svdiv",         .value = BUILTIN(builtin_accel_svdiv)           },
  { .module = "accelerate", .name = "vneg",          .value = BUILTIN(builtin_accel_vneg)            },
  { .module = "accelerate", .name = "vabs",          .value = BUILTIN(builtin_accel_vabs)            },
  { .module = "accelerate", .name = "vclip",         .value = BUILTIN(builtin_accel_vclip)           },
  { .module = "accelerate", .name = "vfill",         .value = BUILTIN(builtin_accel_vfill)           },
  { .module = "accelerate", .name = "vclr",          .value = BUILTIN(builtin_accel_vclr)            },
  { .module = "accelerate", .name = "vramp",         .value = BUILTIN(builtin_accel_vramp)           },
  { .module = "accelerate", .name = "vcopy",         .value = BUILTIN(builtin_accel_vcopy)           },
  { .module = "accelerate", .name = "vcast",         .value = BUILTIN(builtin_accel_vcast)           },
  { .module = "accelerate", .name = "vmath",         .value = BUILTIN(builtin_accel_vmath)           },
  { .module = "accelerate", .name = "vpow",          .value = BUILTIN(builtin_accel_vpow)            },
  { .module = "accelerate", .name = "vspow",         .value = BUILTIN(builtin_accel_vspow)           },
  { .module = "accelerate", .name = "vroundfn",      .value = BUILTIN(builtin_accel_vroundfn)        },
  { .module = "accelerate", .name = "sve",           .value = BUILTIN(builtin_accel_sve)             },
  { .module = "accelerate", .name = "maxv",          .value = BUILTIN(builtin_accel_maxv)            },
  { .module = "accelerate", .name = "minv",          .value = BUILTIN(builtin_accel_minv)            },
  { .module = "accelerate", .name = "countNz",       .value = BUILTIN(builtin_accel_count_nz)        },
  { .module = "accelerate", .name = "vcmpScalar",    .value = BUILTIN(builtin_accel_vcmp_scalar)     },
  { .module = "accelerate", .name = "vcmpArray",     .value = BUILTIN(builtin_accel_vcmp_array)      },
  { .module = "accelerate", .name = "boolIndex",     .value = BUILTIN(builtin_accel_bool_index)      },
  { .module = "accelerate", .name = "boolAssign",    .value = BUILTIN(builtin_accel_bool_assign)     },
  { .module = "accelerate", .name = "vcumsum",       .value = BUILTIN(builtin_accel_vcumsum)         },
  { .module = "accelerate", .name = "vrandn",        .value = BUILTIN(builtin_accel_vrandn)          },
  { .module = "accelerate", .name = "vrand",         .value = BUILTIN(builtin_accel_vrand)           },
  { .module = "accelerate", .name = "mtrans",        .value = BUILTIN(builtin_accel_mtrans)          },
  { .module = "accelerate", .name = "transposeNd",   .value = BUILTIN(builtin_accel_transpose_nd)    },
  { .module = "accelerate", .name = "broadcastBinop",.value = BUILTIN(builtin_accel_broadcast_binop) },
  { .module = "accelerate", .name = "sumAxis0",      .value = BUILTIN(builtin_accel_sum_axis0)       },
  { .module = "accelerate", .name = "vget",          .value = BUILTIN(builtin_accel_vget)            },
  { .module = "accelerate", .name = "vset",          .value = BUILTIN(builtin_accel_vset)            },
  { .module = "accelerate", .name = "fromList",      .value = BUILTIN(builtin_accel_from_list)       },
  { .module = "accelerate", .name = "fromList2d",    .value = BUILTIN(builtin_accel_from_list2d)     },
  { .module = "accelerate", .name = "toList",        .value = BUILTIN(builtin_accel_to_list)         },
  { .module = "accelerate", .name = "vselect",       .value = BUILTIN(builtin_accel_vselect)         },
  { .module = "accelerate", .name = "oneHot",        .value = BUILTIN(builtin_accel_one_hot)         },
  { .module = "accelerate", .name = "argmaxAxis1",   .value = BUILTIN(builtin_accel_argmax_axis1)    },
  { .module = "accelerate", .name = "vtrace",        .value = BUILTIN(builtin_accel_vtrace)          },
  { .module = "accelerate", .name = "arrayEq",       .value = BUILTIN(builtin_accel_array_eq)        },
  { .module = "accelerate", .name = "vmulMask",      .value = BUILTIN(builtin_accel_vmul_mask)       },
  { .module = "accelerate", .name = "addRow",        .value = BUILTIN(builtin_accel_add_row)         },
  { .module = "accelerate", .name = "accuracy",      .value = BUILTIN(builtin_accel_accuracy)        },
  { .module = "accelerate", .name = "fromBytes",     .value = BUILTIN(builtin_accel_from_bytes)      },
  { .module = "accelerate", .name = "softmax",       .value = BUILTIN(builtin_accel_softmax)         },
  { .module = "accelerate", .name = "crossEntropy",  .value = BUILTIN(builtin_accel_cross_entropy)   },
  { .module = "accelerate", .name = "causalSoftmax", .value = BUILTIN(builtin_accel_causal_softmax)  },
  { .module = "accelerate", .name = "promote",       .value = BUILTIN(builtin_accel_promote)         },
  { .module = "accelerate", .name = "hstack2d",      .value = BUILTIN(builtin_accel_hstack_2d)       },
  { .module = "accelerate", .name = "fromRaw",       .value = BUILTIN(builtin_accel_from_raw)        },
  { .module = "accelerate", .name = "sliceCols",     .value = BUILTIN(builtin_accel_slice_cols)      },
  { .module = "accelerate", .name = "mhaForward",    .value = BUILTIN(builtin_accel_mha_forward)     },
  { .module = "accelerate", .name = "mhaForwardOne", .value = BUILTIN(builtin_accel_mha_forward_one) },
  { .module = "accelerate", .name = "mhaBackward",   .value = BUILTIN(builtin_accel_mha_backward)    },
  { .module = "accelerate", .name = "kvCacheAlloc",  .value = BUILTIN(builtin_accel_kv_cache_alloc)  },
  { .module = "accelerate", .name = "causalSoftmaxBackward", .value = BUILTIN(builtin_accel_causal_softmax_backward) },
