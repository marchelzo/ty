...
#include "errno_constants.h"
  ...
  { .module = "accelerate", .name = "vexp",   .value = BUILTIN(builtin_accel_vexp)   },
  { .module = "accelerate", .name = "vlog",   .value = BUILTIN(builtin_accel_vlog)   },
  { .module = "accelerate", .name = "vsqrt",  .value = BUILTIN(builtin_accel_vsqrt)  },
  { .module = "accelerate", .name = "vsin",   .value = BUILTIN(builtin_accel_vsin)   },
  { .module = "accelerate", .name = "vcos",   .value = BUILTIN(builtin_accel_vcos)   },
  { .module = "accelerate", .name = "vtan",   .value = BUILTIN(builtin_accel_vtan)   },
  { .module = "accelerate", .name = "vasin",  .value = BUILTIN(builtin_accel_vasin)  },
  { .module = "accelerate", .name = "vacos",  .value = BUILTIN(builtin_accel_vacos)  },
  { .module = "accelerate", .name = "vatan",  .value = BUILTIN(builtin_accel_vatan)  },
  ...
  { .module = "accelerate", .name = "vsign",  .value = BUILTIN(builtin_accel_vsign)  },
  { .module = "accelerate", .name = "vfloor", .value = BUILTIN(builtin_accel_vfloor) },
  { .module = "accelerate", .name = "vceil",  .value = BUILTIN(builtin_accel_vceil)  },
  { .module = "accelerate", .name = "vround", .value = BUILTIN(builtin_accel_vround) },
