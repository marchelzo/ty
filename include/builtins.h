...
{ .module = NULL,     .name = "array",             .value = BUILTIN(builtin_array)                         },
{ .module = NULL,     .name = "dict",              .value = BUILTIN(builtin_dict)                          },
{ .module = NULL,     .name = "blob",              .value = BUILTIN(builtin_blob)                          },
{ .module = NULL,     .name = "Object",            .value = CLASS(0)                                       },
{ .module = NULL,     .name = "Function",          .value = CLASS(1)                                       },
