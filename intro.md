...
#### List comprehension (yields `[1, 2, 3, 1, 2, 3, 1, 2, 3]`)
```js
...
##### Or between pipe characters with `#` as the implicit parameter
```js
...
parent's parent, etc. All classes are subclasses of `Object`, which itself has
no parent.
